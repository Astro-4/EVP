...
namespace EVP.Data.Migrations
{
    ...
    [Migration("20210211012134_first")]
    partial class first
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventsPlus.Models.Booking", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EventsPlus.Models.Payment", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EventsPlus.Models.Role", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EventsPlus.Models.Venue", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EventsPlus.Models.Event", b =>
                {
                    b.HasOne("EventsPlus.Models.Venue", "Venue")
                        .WithMany("Events")
            ...
            modelBuilder.Entity("EventsPlus.Models.Payment", b =>
                {
                    b.HasOne("EventsPlus.Models.Booking", "Booking")
                        .WithMany()
            ...
            modelBuilder.Entity("EventsPlus.Models.User", b =>
                {
                    b.HasOne("EventsPlus.Models.Role", "Role")
                        .WithMany("Users")
